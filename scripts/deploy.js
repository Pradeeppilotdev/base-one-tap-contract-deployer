...
async function main() {
  ...
  console.log("StringStorage bytecode length:", (await hre.ethers.provider.getCode(stringStorageAddress)).length);
  ...
  console.log("Calculator bytecode length:", (await hre.ethers.provider.getCode(calculatorAddress)).length);
  ...
  console.log("Counter bytecode length:", (await hre.ethers.provider.getCode(counterAddress)).length);
